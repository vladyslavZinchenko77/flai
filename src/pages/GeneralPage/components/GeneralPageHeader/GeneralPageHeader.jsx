  ...
  return (
    <HeaderWrapper>
        ...
        <HeaderUpdateGroup>
            ...
            <HeaderUpdateInfo>Date added to the platform: 17.12.2023</HeaderUpdateInfo>
            </HeaderUpdateTextGroup>
        
        <HeaderBtnGroup>
            <HeaderBtn ><SvgIcon name={'update'} margin={"0 6px 0 0"}/> Update</HeaderBtn >
            <HeaderBtn ><SvgIcon name={'download'} margin={"0 6px 0 0"}/> Download</HeaderBtn >
        </HeaderBtnGroup>
        </HeaderUpdateGroup>
        </HeaderWrapper>
  )
