      ...
      <RecomendationsGroup>
        ...
        <Recomendation >
            <RecomendationItemNoActive>
                <CheckBoxCustom margin={'0 10px 0 0'} />
                <CustomText fontsize='12px' color='#8E8F92'>Release day</CustomText>
            </RecomendationItemNoActive>
        </Recomendation >
        <Recomendation >
            <RecomendationItem>
        ...
        <Recomendation >
            <RecomendationItemNoActive>
                <CheckBoxCustom margin={'0 10px 0 0'} />
                <CustomText fontsize='12px' color='#8E8F92'>Duet</CustomText>
                <SvgIcon name={'lock'} margin={"0 6px 0 20px"}/>
                <CustomText fontsize='12px' color='#D1FD0A'>Coming Soon</CustomText>
            </RecomendationItemNoActive>
        </Recomendation >
        <Recomendation >
            <RecomendationItemNoActive>
                <CheckBoxCustom margin={'0 10px 0 0'} />
                <CustomText fontsize='12px' color='#8E8F92'>The best location for the potential of your sound</CustomText>
                <SvgIcon name={'lock'} margin={"0 6px 0 20px"}/>
                <CustomText fontsize='12px' color='#D1FD0A'>Coming Soon</CustomText>
            </RecomendationItemNoActive>
        </Recomendation >
