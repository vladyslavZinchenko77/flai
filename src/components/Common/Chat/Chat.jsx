...
export const Chat = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Message avatarUrl={avatarimg} name={'You'} time={'3m ago'} text={"ccercercweddwecnbhjc jncrekjcej"} />
        <Message avatarUrl={avatarAiimg} name={'GE'} time={'2m ago'} text={"cewdcwcwc crceece cecercerc ccsdd"} />
      </div>
      <InputWrapper>
        <Input type="text" placeholder="Enter your request..." value={inputValue} onChange={handleInputChange} />
        <SendButton>
